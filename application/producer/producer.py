...
def get_recipes():
    recipies = []
    salad_url = 'https://www.allrecipes.com/recipes/217/salad/'
    url = 'https://www.allrecipes.com/recipes/217/salad/'
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            links = soup.find_all("a", {"class": "card__titleLink manual-link-behavior elementFont__titleLink margin-8-bottom"})
            idx = 0
            for link in links:
